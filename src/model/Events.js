...
const Events = [
    new EventModel(
        ...
        new Consequences(
            "Du bekommst viele Likes und eine Marke will mit dir Werbung machen.",
            0,
            +3,
            +2,
            0
    ...
    new EventModel(
        ...
        new Consequences(
            "Das Video erhält viele Aufrufe, deine Fans finden deinen Auftritt aber komisch. Außerdem war der Dreh echt zeitaufwändig.",
            +3,
            -1,
            0,
            -1
    ...
    new EventModel(
        ...
        new Consequences(
            "Deine Fans folgen deiner Empfehlung, kaufen das Produkt und sind enttäuscht.",
            0,
            -2,
            +3,
            0
    ...
    new EventModel(
        ...
        new Consequences(
            "Ein bezahlter Urlaub und reichlich Material für deine Social-Media-Angebote. Aber du konntest weniger Zeit als geplant mit deiner Familie verbringen.",
            +2,
            0,
            +2,
            -1
    ...
    new EventModel(
        ...
        new Consequences(
            "Du erhältst viel Zuspruch von anderen Medienstars und deine Fans loben dein Verhalten.",
            +2,
            +3,
            0,
            0
    ...
    new EventModel(
        ...
        new Consequences(
            "Dein Beitrag erhält sehr viel Aufmerksamkeit, deine Fans mögen euch als Paar.",
            +2,
            +2,
            0,
            -1
    ...
    new EventModel(
        ...
        new Consequences(
            "Eure Videos bekommen enorme Aufmerksamkeit und du bekommst sogar Anfragen aus dem Fernsehen! Doch du wirst ganz oft auch als Schuldige:r an dem Streit dargestellt. Das macht dir zu schaffen.",
            +2,
            -1,
            +1,
            -1
    ...
    new EventModel(
        ...
        new Consequences(
            "Die Show schauen sehr viele Leute. Von dir werden einige private Infos bekannt",
            +2,
            0,
            +1,
            -2
        ...
        new Consequences(
            "Die Show hatte zwar nicht so viele Zuschauer:innen, aber dein Auftritt kam gut an.",
            +1,
            +3,
            +1,
            0
    ...
    new EventModel(
        ...
        new Consequences(
            "Das Klatsch-Magazin will öfter mit dir zusammenarbeiten. Das befreundete Pärchen möchte aber nichts mehr mit dir zu tun haben.",
            +3,
            0,
            0,
            -2
    ...
    new EventModel(
        ...
        new Consequences(
            "Du bist jede Woche im TV zu sehen und es gibt viel über dich zu berichten.",
            +3,
            0,
            +2,
            0
    ...
    new EventModel(
        ...
        new Consequences(
            "Deine Fans mögen, dass du auf ihre Themenvorschläge eingehst. Dein Konzept ist allerdings nicht durchdacht und bekommt langfristig nicht genug Zuhörer:innen.",
            +2,
            +2,
            +1,
            0
    ...
    new EventModel(
        ...
        new Consequences(
            "Das Publikum findet dein Interview zwar interessant. Dass du bei den persönlichen Fragen ausgewichen bist, kommt aber weniger gut an.",
            +2,
            -2,
            0,
            +1
    ...
    new EventModel(
        ...
        new Consequences(
            "Deine Freund:innen freuen sich den Abend mit dir zu verbringen. Einige Fans sind geknickt, sie haben zum Teil lange warten müssen, haben dich aber gar nicht zu Gesicht bekommen. Einige entfolgen dir sogar auf deinen Social-Media-Kanälen.",
            -1,
            -2,
            0,
            +2
    ...
    new EventModel(
        ...
        new Consequences(
            "Die Fans sind unzufrieden und verbreiten ihre Ansichten über dich in ihren SocialMedia-Profilen.",
            0,
            -2,
            0,
            +3
    ...
    new EventModel(
        "Fantreffen",
        "Du möchtest ein Fantreffen veranstalten",
        ...
        new Consequences(
            "Es kommen sehr viele Fans und freuen sich riesig, dich zu sehen. Leider ist so viel Andrang, dass nicht alle die Gelegenheit haben dich kennenzulernen.",
            +3,
            +2,
            0,
            0
    ...
    new EventModel(
        ...
        new Consequences(
            "Das Fantreffen läuft gut. Du bist allerdings danach völlig fertig.",
            +1,
            +2,
            0,
            -2
    ...
    new EventModel(
        ...
        new Consequences(
            "Einige deiner Fans sind richtig enttäuscht, andere finden es gut, dass du zu dir stehst.",
            -2,
            0,
            0,
            +3
